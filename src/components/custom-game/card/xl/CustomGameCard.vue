  ...
  <v-card>
    <v-toolbar :color="teamColor" dark flat>
      <v-toolbar-title v-if="customGame.blueTeamSummoners[0].win"
        >Blue팀
        <v-icon medium color="#fbc02d" class="ml-1"
          ...
          <v-card-text>
            ...
            >
              ...
              <CustomGameCardItem
                ...
                :number="7"
              />
              <CustomGameCardVisionScore
                class="mx-2"
                :summoner="getTeamSummoner(tabName, customGame, index)"
              />
              <CustomGameCardWardsPlaced
                class="mx-2"
                :summoner="getTeamSummoner(tabName, customGame, index)"
              />
              <CustomGameCardWardsKilled
                class="mx-2"
                :summoner="getTeamSummoner(tabName, customGame, index)"
              />
              <CustomGameCardVisionWardsBoughtInGame
                class="mx-2"
                :summoner="getTeamSummoner(tabName, customGame, index)"
              />
...
import CustomGameCardVisionScore from "@/components/custom-game/CustomGameCardVisionScore";
import CustomGameCardWardsPlaced from "@/components/custom-game/CustomGameCardWardsPlaced";
import CustomGameCardWardsKilled from "@/components/custom-game/CustomGameCardWardsKilled";
import CustomGameCardVisionWardsBoughtInGame from "@/components/custom-game/CustomGameCardVisionWardsBoughtInGame";
